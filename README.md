...
```
-----安装command bash <(wget -qO- -o- https://git.io/v2ray.sh)

               wget https://github.com/jamy25/v2ray/archive/master.tar.gz -O v2ray-master.tar.gz;tar -zxvf v2ray-master.tar.gz;cd v2ray-master;chmod +x i*;./i* -l
